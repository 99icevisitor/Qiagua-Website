...
<html>
  <head>
	...
	<link rel="stylesheet" type="text/css" href="CSS/ArticleManager.css">
  	...
  	<style type="text/css">
  		#id1{
  			margin-top: 130px;<%--every article occupies 130px--%>
  		}
  		#id2{
  			margin-top: 260px;
  		}
		...
		<div class="RightDiv">
			...
			<div class="content-detials">
				<ul>
					...
					<li><a class="modify-article" href=""><p class="article-title">文章标题TITLE1</p></a> <p class="article-time">编辑于2019年3月4日 20:39</p></li>
			...
			<div class="content-detials" id="id1">
				<ul>
					<li><img src="images/main/kker.jpg" alt="文章图片" class="article-img"></li>
					<li><a class="modify-article" href=""><p class="article-title">文章标题TITLE2</p></a> <p class="article-time">编辑于2019年3月18日 20:56</p></li>
					<li class="article-modify">
						<div class="article-modify-button"><a href="">管理</a></div>
				        <ul class="drop-down-content">
				          <li >
			...
			<div class="content-detials" id="id2">
				<ul class="drop-down1">
					<li><img src="images/main/kker.jpg" alt="文章图片" class="article-img"></li>
					<li><a class="modify-article" href=""><p class="article-title">文章标题TITLE3</p></a> <p class="article-time">编辑于2019年5月29日 06:56</p></li>
					<li class="article-modify">
						<div class="article-modify-button"><a href="">管理</a></div>
				        <ul class="drop-down-content">
				          <li >
