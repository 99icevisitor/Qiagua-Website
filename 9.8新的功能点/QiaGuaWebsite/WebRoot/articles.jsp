   ...
   <body>
    ...
    <center>
   	...
   	<div class="box1">
          ...
          <p style="margin-left: 90PX;margin-top: -10px; color:838383;font-size: 6px;">2019年8月20日 16:00</p>
          <p>发布文章</p>
          <p><img   src="images/user/文章/1.jpg"  style="width: 350px;height: 200px;margin-left: 10PX;"></p>
   	    </div>
   	  	<div class="right">
   	  		  <a href="trace.jsp" >
            <button class="button">
            ...
            <span style="color: #000000;"></i>收藏</span>
            </button></a><br/>
