	...
	<div class="mainDiv tab">
		...
		<div class="RightDiv">
			<div class="content-drafts">
				...
				<div class="add-button"><a class="add-word" href="">+上传图片</a></div>
			</div>
			...
			<div class="content-detials" id="id1">
				<ul>
					<li><img src="images/main/kker.jpg" alt="素材图片" class="article-img"></li>
					<li><p class="article-title">图片2</p> <p class="article-time">编辑于2019年3月18日 20:56</p></li>
					<li class="article-modify">
						<div class="article-modify-button"><a href="">管理</a></div>
				        <ul class="drop-down-content">
				          <li >
			...
			<div class="content-detials" id="id2">
				<ul class="drop-down1">
					<li><img src="images/main/kker.jpg" alt="素材图片" class="article-img"></li>
					<li><p class="article-title">图片3</p> <p class="article-time">编辑于2019年5月29日 06:56</p></li>
					<li class="article-modify">
						<div class="article-modify-button"><a href="">管理</a></div>
				        <ul class="drop-down-content">
				          <li >
